...
const HeroPage = () => {
    return (
        <section className='flex w-[90%] ml-auto mb-16 gap-8 max-md:mb-32 max-sm:flex-col-reverse max-sm:mx-auto max-sm:text-center max-sm:w-[100%] overflow-hidden'>
            <div className='flex flex-col items-start justify-center gap-2 max-sm:items-center  max-sm:max-w-[400px] max-sm:w-[90%] max-sm:m-auto'>
                ...
                <button className='teal  py-2 px-8 rounded-2xl' onClick={() => window.location.href = '#shorten'}>Get Started</button>
            </div>
